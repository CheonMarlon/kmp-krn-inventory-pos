...
import { Mail, Facebook, Phone, MapPin, Send } from "lucide-react";
  ...
  return (
    <section className="contact-layout">
      <div className="top-center">
        <img src="/stickers/gitna.png" alt="Kampo Karne Logo" className="center-logo" />
        <img src="/stickers/babagitna.png" alt="Background" className="center-back" />
      </div>
      ...
      <div className="bottom-section">
        <img className="test" src="/stickers/bottombg.png" alt="" />
        ...
        <div className="cow">
          <img src="/stickers/cow.png" alt="Cow Sticker" />
        </div>
      </div>
    </section>
  );
